...
Authoring component for the **File** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-file-edit
```
...
```ts
import { Edit } from '@tailor-cms/ce-file-edit';
```
