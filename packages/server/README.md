...
Server-side module for the **File** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-file-server
```
...
```ts
import serverModule from '@tailor-cms/ce-file-server';
```
